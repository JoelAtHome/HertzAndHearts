...
7. Optional saved-HRV check: phone **Record HRV** alone → Stop → connect HnH (or **More → Saved Phone Recordings…** and pick the row) → status mentions Session History → **More → Session History…** shows the row (ECG in **More → Session Replay…** when the package included it).
